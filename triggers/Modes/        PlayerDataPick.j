            ...
            if (this.canPick()){
                if (this.isRandoming()){
                    ...
                    if (this.class() == PlayerData.CLASS_TITAN) 
                        this.say("|cff00bfffYou may now choose the titan of your choice and wreak havok upon the defenders.|r");
                    else 
                        this.say("|cff00bfffYou may now choose your Defender.|r");
