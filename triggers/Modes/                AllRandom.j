...
library RacePickModeAllRandom requires RacePickMode {
    public struct RacePickModeAllRandom extends RacePickMode {
        ...
        method description() -> string {
            return "All races will be selected at random.";
        }
        ...
        method start(){
            ...
            for (0 <= i < list.size()){
                ...
                // Check that they're still playing first
