...
library SypheriousNuke requires GameTimer, GT, xebasic, xepreload, xecollider, GenericTitanTargets {
    private struct SypheriousNukeWave extends xecollider {
        private SypheriousNuke object = 0;
        public method setNukeObject(SypheriousNuke object){
            this.object = object;
        }
    ...
    private struct SypheriousNuke {
        private static constant integer ABILITY_ID = 'TSAQ';
        private static constant string WAVE_EFFECT = "Abilities\\Spells\\Other\\CrushingWave\\CrushingWaveMissile.mdl";
        private static constant string TARGET_EFFECT = "Abilities\\Spells\\Other\\CrushingWave\\CrushingWaveDamage.mdl";
        ...
        private SypheriousNukeWave wave = 0;
        ...
        private static method begin(unit caster, real x, real y, integer level) -> thistype {
            ...
            this.wave = SypheriousNukeWave.create(castX, castY, angle);
            ...
            this.wave.scale = 0;
            this.wave.speed = (this.distance / 0.2); // How far it travels in 1 second.
        ...
        private static method onCast(){
            ...
            SypheriousNuke.begin(caster, x, y, level);
        }
    ...
    private function onInit(){
        SypheriousNuke.onSetup.execute();
    }
}
