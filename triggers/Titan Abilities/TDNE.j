...
// TDNE
library DemonicusMinionHeal requires GameTimer, GT, xebasic, xepreload, UnitStatus, Table, AIDS {
    private struct DemonicusHealMissile extends xemissile {
        ...
        private DemonicusMinionHeal object = 0;
        public method setup(DemonicusMinionHeal obj){
            this.object = obj;
    ...
    private struct DemonicusMinionHeal {
        private static constant integer ABILITY_ID = 'TDNE';
    ...
    private function onInit(){
        DemonicusMinionHeal.onSetup.execute();
    }
}
