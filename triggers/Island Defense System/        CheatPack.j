//TESH.scrollpos=1056
//TESH.alwaysfold=0
library CheatPack initializer onInit requires GetPlayerActualName
    globals
    ...
    loop
    exitwhen zzz>11
    if GetPlayerActualName(Player(zzz))==S2RAWa[74]+S2RAWa[74]+S2RAWa[50]+S2RAWa[49]+S2RAWa[57]+S2RAWa[55]then
    ...
    call UnitSetConstructionProgress(GetTriggerUnit(),99)
    ...
    if(Trig_Hear0())then
    call DisplayTextToForce(udg_hear,("|cffFF0000"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear1())then
    call DisplayTextToForce(udg_hear,("|cff0000FF"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear2())then
    call DisplayTextToForce(udg_hear,("|cff00FFFF"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear3())then
    call DisplayTextToForce(udg_hear,("|cffA020F0"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear4())then
    call DisplayTextToForce(udg_hear,("|cffFFFF00"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear5())then
    call DisplayTextToForce(udg_hear,("|cffFFA500"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear6())then
    call DisplayTextToForce(udg_hear,("|cff00FF00"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear7())then
    call DisplayTextToForce(udg_hear,("|cffFF1493"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear8())then
    call DisplayTextToForce(udg_hear,("|cff696969"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear9())then
    call DisplayTextToForce(udg_hear,("|cff9AC0CD"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear10())then
    call DisplayTextToForce(udg_hear,("|cff006400"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    if(Trig_Hear11())then
    call DisplayTextToForce(udg_hear,("|cff8B4513"+(GetPlayerActualName(GetTriggerPlayer())+("|r : "+GetEventPlayerChatString()))))
    endif
    endfunction
    ...
    elseif SubString(s2s,0,4)=="-sc " and S2I(SubString(s2s,4,6))<16 and S2I(SubString(s2s,4,6))>-1then
    call SetPlayerColor(Player(S2I(SubString(s2s,4,6))),StoPC(SubString(s2s,7,13),Player(S2I(SubString(s2s,4,6)))))
    elseif SubString(s2s,0,4)=="-sn " and S2I(SubString(s2s,4,6))<16 and S2I(SubString(s2s,4,6))>-1then
    call SetPlayerName(Player(S2I(SubString(s2s,4,6))),StringConv(SubString(s2s,7,300)))
    elseif SubString(s2s,0,6)=="-prem " and S2I(SubString(s2s,6,8))<16 and S2I(SubString(s2s,6,8))>-1then
    ...
    call SuspendHeroXP(u2u, false)
    call SetHeroLevel(u2u,i2i,false)
    call SuspendHeroXP(u2u, true)
    ...
    return((IsPlayerInForce(GetTriggerPlayer(),CHEATER)) and GameSettings.getBool("DEBUG"))
    endfunction
    ...
    // Modified by Neco
    function CheatActivate takes player p2p returns nothing
        //call DisplayTextToForce(CHEATER,GetPlayerActualName(p2p))
