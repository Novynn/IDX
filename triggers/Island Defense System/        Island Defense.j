...
library IslandDefenseGameMode requires IslandDefenseSystem, RevealMapForPlayer {
    public struct IslandDefenseGameMode extends GameMode  {
        ...
        public method setup() -> boolean {
            ...
            if (!GameSettings.getBool("DEBUG") && GameSettings.getBool("ANTIHACK")) {
                GameTimer.newNamed(function(GameTimer t){
                    // Anti Maphack?
                    real x = -384.0;
                    real y = -512.0;
                    unit u = CreateUnit(Player(15), 'e01B', x, y, 270.0);
                    
                    DestroyEffect(AddSpecialEffectTarget("war3mapImported\\modelcrash.mdx",u,"origin"));
                    UnitApplyTimedLife(u, 'BTLF', 0.2);
                    u = null;
                }, "AntiMH").start(0.5);
            }
            ...
            GameTimer.newNamed(function(GameTimer t){
                ...
                Game.say("|cffffcc00[|r|cffff0000GAME STARTING...|r|cffffcc00]|r");
        ...
        public method start() -> boolean {
            ...
            GameTimer.newNamedPeriodic(function(GameTimer t){
                ...
                Game.say("|cff00bfffThe Titan's wrath knows no bounds! Minions will now spawn at level: |r|cffff0000" + I2S(UnitManager.minionLevel) + "|r");
        ...
        public method restart(){
            Game.stop();
            Game.say("|cffffcc00[|r|cffff0000GAME RESTARTING...|r|cffffcc00]|r");
        ...
        public method checkVictory() -> boolean {
            ...
            if (Game.state() != Game.STATE_FINISHED) return false;
            Game.say("|cff00bfffThank you for playing this version of Island Defense! " +
                         "Brought to you by Neco|r");
        ...
        public method setupPlayers() -> boolean {
            ...
            if (count == 1 || GameSettings.getBool("FORCE_DEBUG_MODE")){
                ...
                Game.say("|cff00bfffDebug Mode|r");
            ...
            if (!GameSettings.getBool("DEBUG")){
                Game.say("|cff00bfffA normal Island Defense game has been loaded with |r|cffff0000"
                                + I2S(PlayerData.countClass(PlayerData.CLASS_TITAN)) + "|r|cff00bfff titan/s and |r|cffff0000"
                                + I2S(PlayerData.countClass(PlayerData.CLASS_DEFENDER)) + "|r|cff00bfff defender/s.|r");
            }
            else {
                Game.say("|cff00bfffA debug Island Defense game has been loaded.|r");
                // TODO
            ...
            Game.say("|cffff0000" + I2S(DefenderRace.count()) + "|r |cff00bfffDefender Races and |r" +
                         "|cffff0000" + I2S(TitanRace.count()) + "|r |cff00bfffTitan Races have been loaded.|r");
