...
library UnitSpawner requires Unit, Players {    
    public module UnitSpawner {
        ...
        public static method spawnShops(){
            thistype.ARTIFACTS_PAGE_ONE     = CreateUnit(Player(PLAYER_NEUTRAL_AGGRESSIVE), ARTIFACTS_PAGE_ONE_ID  ,     64,  -320, 270);
            thistype.ARTIFACTS_PAGE_TWO     = CreateUnit(Player(PLAYER_NEUTRAL_AGGRESSIVE), ARTIFACTS_PAGE_TWO_ID  ,     64,  -319, 270);
            thistype.CONSUMABLES_PAGE_ONE   = CreateUnit(Player(PLAYER_NEUTRAL_AGGRESSIVE), CONSUMABLES_PAGE_ONE_ID,   -128, -1025, 270);
            thistype.CONSUMABLES_PAGE_TWO   = CreateUnit(Player(PLAYER_NEUTRAL_AGGRESSIVE), CONSUMABLES_PAGE_TWO_ID,   -128, -1024, 270);
            thistype.RECIPES_PAGE_ONE       = CreateUnit(Player(PLAYER_NEUTRAL_AGGRESSIVE), RECIPES_PAGE_ONE_ID    ,   -896,  -320, 270);
            thistype.RECIPES_PAGE_TWO       = CreateUnit(Player(PLAYER_NEUTRAL_AGGRESSIVE), RECIPES_PAGE_TWO_ID    ,   -896,  -319, 270);
