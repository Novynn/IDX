...
//! textmacro SETUP_DEFAULT_SETTINGS
    ...
    GameSettings.setInt("PICKMODE_RACE_BAN_MAX", 3);
    GameSettings.setInt("PICKMODE_RACE_BAN_MAX_TITANS", 1);
    
    GameSettings.setReal("GAME_INIT_START_DELAY", 5.0);
    
    GameSettings.setBool("STARTGAME_MESSAGE_ENABLED", false);
    GameSettings.setStr ("STARTGAME_MESSAGE_TEXT", "");
    ...
    GameSettings.setBool("FORCE_FAKE_PLAYERS", false);
    GameSettings.setBool("FAKE_PLAYERS_AUTOPICK", true);
    GameSettings.setBool("FORCE_FAKE_PLAYERS_WHEN_ALONE", true);
    ...
    GameSettings.setInt ("TITAN_START_GOLD", 15);
