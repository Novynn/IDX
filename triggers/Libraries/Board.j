//TESH.scrollpos=0
//TESH.alwaysfold=0
library Board requires ARGB, GetPlayerActualName
//==============================================================================
// Board v0.2.01
//==============================================================================
// Credits:
...
private struct VisibleHelper extends array
    public method operator []= takes player p, boolean b returns nothing
        if GetPlayerId(p) > 11 then
            debug call ErrorMsg("Board.visible[\"" + GetPlayerActualName(p) + "\"]=" + B2S(b), "Given player is a neutral player")
            return
        endif
...
struct Board
    ...
    public method get takes nothing returns multiboard
        return bBoard
    endmethod
