// MODIFIED BY NECO TO REQUIRE AIDS INSTEAD OF AUTOINDEX
...
globals
    ...
    constant integer MIN_UNIT_MOVEMENT = 0
    constant integer MAX_BUILDING_MOVEMENT = 522
    constant integer MIN_BUILDING_MOVEMENT = 0
endglobals
...
private function OnInit takes nothing returns nothing
    ...
    call AIDS_RegisterOnDeallocate(Condition(function OnLeaveMap))
