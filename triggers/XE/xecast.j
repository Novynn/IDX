//TESH.scrollpos=272
//TESH.alwaysfold=0
library xecast initializer init requires xebasic optional AIDS
//******************************************************************************
// xecast 0.9
// ------
...
//==============================================================================
 globals
    ...
    private constant boolean FORCE_INVISIBLE_CAST = true
...
struct xecast_storage extends array
    public integer data
endstruct
...
struct xecast[MAXINSTANCES]
    ...
    public real    recycledelay = 1.0  //Please notice, some spells need a recycle delay
    ...
    method castOnTarget takes unit target returns boolean
     ...
     local boolean cast = false
        ...
        static if (FORCE_INVISIBLE_CAST) then
            ...
            set cast = IssueTargetOrderById(dummy,this.oid,target)
