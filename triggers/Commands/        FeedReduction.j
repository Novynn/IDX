...
library FeedReductionTweak requires TweakManager {
    public struct FeedReductionTweak extends Tweak {
        module TweakModule;
        
        public method name() -> string {
            return "Feed Reduction Disable";
        }
        public method shortName() -> string {
            return "FROFF";
        }
        public method description() -> string {
            return "Turns off the feed reduction system, ensuring the Titan gains experience at the full rate.";
        }
        ...
        public method activated() -> boolean {
            return (!GameSettings.getBool("TITAN_EXP_REDUCTION_ENABLED"));
        }
