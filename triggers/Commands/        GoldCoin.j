...
library GoldCoinTweak requires TweakManager {
    public struct GoldCoinTweak extends Tweak {
        module TweakModule;
        ...
        public method description() -> string {
            return "Gold Coins have a chance to drop from the Titan and his minions' kills.";
        }
        ...
        public method activated() -> boolean {
            return (GameSettings["TWEAK_GC"] == "on");
        }
