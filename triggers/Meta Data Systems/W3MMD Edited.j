...
///////////////////////////////////////////////////////////////
library MMD initializer init requires GetPlayerActualName
    globals
    ...
    globals
        ...
        public constant integer CURRENT_VERSION = 1
    ...
    */
    ...
    private function update_value takes string name, player p, string op, string value, integer val_type returns nothing
        ...
        elseif val_type != GetStoredInteger(gc, "types", name) then
            call BJDebugMsg("MMD Set Error: Updated value of undefined variable or used value of incorrect type: " + name)
    ...
    private function init2 takes nothing returns nothing
        ...
        //    exitwhen i >= 12
        //    if GetPlayerController(Player(i)) == MAP_CONTROL_USER and GetPlayerSlotState(Player(i)) == PLAYER_SLOT_STATE_PLAYING then
        //        call emit("init pid " + I2S(i) + " " + pack(GetPlayerActualName(Player(i))))
        //    endif
        //    set i = i + 1
        //endloop
