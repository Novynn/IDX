...
library MultiboardTitan requires MultiboardManager, Board, ExperienceSystem {
    public struct MultiboardTitan extends ClassBoard {
        ...
        public method forClass(integer c) -> boolean {
            return (c == PlayerData.CLASS_TITAN ||
                    c == PlayerData.CLASS_MINION);
        }
        
        public method name() -> string {
            return "MultiboardTitan";
        }
        ...
        public static method header() -> string {
            string s = "|cff6622ffTitan Information|r";
        ...
        public method update(){
            ...
            for (0 <= i < list.size()){
                ...
                if (p.class() == PlayerData.CLASS_TITAN){
                    ...
                    row[thistype.ColumnName].icon = p.race().childIcon();
                }
            ...
            if (list.size() > 0){
                ...
                for (0 <= i < list.size()){
                    ...
                    if (p.class() == PlayerData.CLASS_DEFENDER){
                        ...
                        row[thistype.ColumnRate].text = I2S(R2I(rate * 100.0)) + "%";
